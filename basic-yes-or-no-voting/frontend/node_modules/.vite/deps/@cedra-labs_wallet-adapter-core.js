...
// node_modules/@cedra-labs/wallet-adapter-core/node_modules/eventemitter3/index.js
var require_eventemitter3 = __commonJS({
  "node_modules/@cedra-labs/wallet-adapter-core/node_modules/eventemitter3/index.js"(exports, module) {
    "use strict";
...
// node_modules/@cedra-labs/wallet-adapter-core/dist/index.mjs
...
var NetworkName = (function(NetworkName2) {
...
var isCedraNetwork = function(networkInfo) {
  ...
  return s[networkInfo.name] !== void 0;
};
...
function getSDKWallets(dappConfig) {
  ...
  if ((dappConfig === null || dappConfig === void 0 ? void 0 : dappConfig.network) === t.MAINNET) {
  } else {
  }
  return sdkWallets;
}
  ...
  _create_class(WalletCore2, [
    {
      ...
      value: function fetchExtensionAIP62CedraWallets() {
        var _getCedraWallets = f2(), cedraWallets = _getCedraWallets.cedraWallets, on = _getCedraWallets.on;
        this.setExtensionAIP62Wallets(cedraWallets);
        if (typeof window === "undefined") return;
        var that = this;
        var removeRegisterListener = on("register", function() {
          var _getCedraWallets2 = f2(), cedraWallets2 = _getCedraWallets2.cedraWallets;
            ...
            return _ts_generator(this, function(_state) {
              switch (_state.label) {
                ...
                case 2:
                  ...
                  if (response3.status === r.REJECTED) {
                    throw new WalletConnectionError("User has rejected the request").message;
                  }
                  return [
                    2,
                ...
                case 4:
                  ...
                  if (response2.status === r.REJECTED) {
                    throw new WalletConnectionError("User has rejected the request").message;
                  }
                  return [
                    2,
            ...
            return _ts_generator(this, function(_state) {
              switch (_state.label) {
                ...
                case 4:
                  ...
                  if (response1.status === r.REJECTED) {
                    throw new WalletConnectionError("User has rejected the request").message;
                  }
                  return [
                    2,
...
//# sourceMappingURL=@cedra-labs_wallet-adapter-core.js.map
