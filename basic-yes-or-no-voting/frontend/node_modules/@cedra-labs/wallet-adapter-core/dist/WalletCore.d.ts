...
import { AccountAuthenticator, AnyRawTransaction, InputSubmitTransactionData, Network, PendingTransactionResponse } from "@cedra-labs/ts-sdk";
import { CedraWallet, CedraSignAndSubmitTransactionOutput, NetworkInfo, AccountInfo, CedraSignMessageInput, CedraSignMessageOutput, CedraChangeNetworkOutput, CedraSignInInput, CedraSignInOutput } from "@cedra-labs/wallet-standard";
import { CedraConnectWalletConfig } from "@cedra-labs/wallet-adapter-plugin";
export type { NetworkInfo, AccountInfo, CedraSignAndSubmitTransactionOutput, CedraSignTransactionOutputV1_1, CedraSignMessageInput, CedraSignMessageOutput, CedraChangeNetworkOutput, } from "@cedra-labs/wallet-standard";
export type { AccountAuthenticator, AnyRawTransaction, InputGenerateTransactionOptions, PendingTransactionResponse, InputSubmitTransactionData, Network, AnyPublicKey, AccountAddress, } from "@cedra-labs/ts-sdk";
...
export declare class WalletCore extends EventEmitter<WalletCoreEvents> {
    ...
    private fetchExtensionAIP62CedraWallets;
    /**
     ...
     */
    private fetchSDKAIP62CedraWallets;
     ...
     */
    signAndSubmitTransaction(transactionInput: InputTransactionData): Promise<CedraSignAndSubmitTransactionOutput>;
    /**
     * Signs a transaction
     *
