import { FeePayerRawTransaction, MultiAgentRawTransaction, RawTransaction } from "@cedra-labs/ts-sdk";
...
export declare function serializeRawTransaction(rawTxn: RawTransaction | RawTransaction): SerializedSimpleRawTransaction;
export declare function serializeRawTransaction(rawTxn: FeePayerRawTransaction | FeePayerRawTransaction): SerializedFeePayerRawTransaction;
export declare function serializeRawTransaction(rawTxn: MultiAgentRawTransaction | MultiAgentRawTransaction): SerializedMultiAgentRawTransaction;
export declare function serializeRawTransaction(rawTxn: SerializableRawTransaction): SerializedRawTransaction;
