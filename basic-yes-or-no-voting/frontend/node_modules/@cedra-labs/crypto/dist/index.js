...
__export(index_exports, {
  ...
  cedraAccountToEd25519Keypair: () => cedraAccountToEd25519Keypair,
  cedraAccountToSerializedInfo: () => cedraAccountToSerializedInfo,
...
function cedraAccountToEd25519Keypair(account) {
...
function serializePublicKeyB64(publicKey) {
  ...
  (0, import_connect_wallet_api.serializePublicKey)(serializer, publicKey);
  return (0, import_connect_wallet_api.bytesToBase64)(serializer.toUint8Array());
}
function deserializePublicKeyB64(publicKeyB64) {
  const serializedPublicKey = (0, import_connect_wallet_api.base64ToBytes)(publicKeyB64);
  const deserializer = new import_ts_sdk3.Deserializer(serializedPublicKey);
  return (0, import_connect_wallet_api.deserializePublicKey)(deserializer);
}
...
function serializeSignatureB64(signature) {
  const serializer = new import_ts_sdk3.Serializer();
  (0, import_connect_wallet_api.serializeSignature)(serializer, signature);
  return (0, import_connect_wallet_api.bytesToBase64)(serializer.toUint8Array());
}
function deserializeSignatureB64(signatureB64) {
  const serializedSignature = (0, import_connect_wallet_api.base64ToBytes)(signatureB64);
  const deserializer = new import_ts_sdk3.Deserializer(serializedSignature);
  return (0, import_connect_wallet_api.deserializeSignature)(deserializer);
}
...
async function cedraAccountToSerializedInfo(account, intentId) {
...
0 && (module.exports = {
  ...
  REQUIRED_FIELDS,
  SIGNATURE_PREFIX,
  cedraAccountToEd25519Keypair,
  cedraAccountToSerializedInfo,
  concatUint8array,
  constructMetadata,
