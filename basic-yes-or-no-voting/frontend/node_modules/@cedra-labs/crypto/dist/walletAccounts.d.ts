import { Account, AccountPublicKey, PublicKey as CedraPublicKey, Signature } from '@cedra-labs/ts-sdk';
 ...
 *    `SHA3-256(SHA3-256('CEDRA::IDENTITY_CONNECT::') | SHA3-256(accountInfoSerialized))`
...
export declare function deriveAccountTransportEd25519Keypair(ed25519SecretKey: Ed25519SecretKey, publicKey: Ed25519PublicKey | CedraPublicKey): Ed25519KeyPair;
export declare function deriveAccountTransportEd25519Keypair(signCallback: SyncSignCallback, publicKey: Ed25519PublicKey | CedraPublicKey): Ed25519KeyPair;
export declare function deriveAccountTransportEd25519Keypair(signCallback: AsyncSignCallback, publicKey: Ed25519PublicKey | CedraPublicKey): Promise<Ed25519KeyPair>;
export declare function deriveAccountTransportEd25519Keypair(signCallback: AnySignCallback, publicKey: Ed25519PublicKey | CedraPublicKey): Ed25519KeyPair | Promise<Ed25519KeyPair>;
...
export declare function cedraAccountToSerializedInfo(account: Account, intentId: string): Promise<AccountConnectInfoSerialized>;
