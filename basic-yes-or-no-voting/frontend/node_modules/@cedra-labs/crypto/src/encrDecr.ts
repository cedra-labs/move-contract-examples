...
import { Ed25519Signature, PublicKey, Signature } from '@cedra-labs/ts-sdk';
...
export const SIGNATURE_PREFIX = 'CEDRA::IDENTITY_CONNECT';
 ...
 * The purpose prefix is constructed as `'CEDRA::IDENTITY_CONNECT' + '::' + purpose + '::'`
