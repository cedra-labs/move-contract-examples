...
import { CedraConfig } from './cedraConfig.mjs';
...
import { CedraObject } from './object.mjs';
...
import '../Ed25519Account-C1D-gIp4.mjs';
...
import '../federatedKeyless-VW1_hFY_.mjs';
...
interface Cedra extends Account, ANS, Coin, DigitalAsset, Event, Faucet, FungibleAsset, General, Keyless, Staking, Table, CedraObject, Omit<Transaction, "build" | "simulate" | "submit" | "batch"> {
}
