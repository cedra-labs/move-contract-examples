...
import { Gavel, Wallet, RefreshCw, PlusCircle, TrendingDown } from 'lucide-react'
import { dutchAuctionClient, type Auction } from '../utils/contract'
...
export default function Home() {
  ...
  const [filter, setFilter] = useState<'all' | 'active' | 'sold' | 'mine'>('all')
  ...
  const fetchAuctions = async (isRefresh = false) => {
    ...
    try {
      const auctionsList = await dutchAuctionClient.getAuctions(100)
  ...
  // Auto-refresh every 5 seconds for price updates
  useEffect(() => {
  ...
  const activeAuctions = auctions.filter(a => !a.isSold)
  const soldAuctions = auctions.filter(a => a.isSold)
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-gray-600 flex items-center gap-2">
                ...
                Prices decrease over time - first buyer wins
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{soldAuctions.length}</p>
                </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-white rounded-lg shadow">
            ...
            <p className="text-gray-600 mb-6">Be the first to create a Dutch auction!</p>
            <Link
              to="/create"
            ...
            {filteredAuctions.length > 0 ? (
              <div>
                <h2 className="text-xl font-bold text-gray-900 mb-4">
                  ...
                  {filter === 'sold' && 'Completed Auctions'}
              ...
              <div className="text-center py-12 bg-white rounded-lg shadow">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-1">
                  ...
                  {filter === 'sold' && 'No Completed Auctions'}
                ...
                <p className="text-gray-600 mb-4">
                  ...
                  {filter === 'sold' && 'No auctions have been completed yet'}
