...
export declare function isCedraConnectWallet(wallet: WalletInfo | AdapterWallet): boolean;
/**
 ...
 */
export declare function getCedraConnectWallets(wallets: ReadonlyArray<AdapterWallet | AdapterNotDetectedWallet>): {
    cedraConnectWallets: AdapterWallet[];
