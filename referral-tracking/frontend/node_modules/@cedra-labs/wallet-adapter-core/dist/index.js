...
__export(index_exports, {
    CEDRA_CONNECT_ACCOUNT_URL: function() {
        return CEDRA_CONNECT_ACCOUNT_URL;
    },
    CEDRA_CONNECT_BASE_URL: function() {
        return CEDRA_CONNECT_BASE_URL;
    },
    ...
    cedraStandardSupportedWalletList: function() {
        return cedraStandardSupportedWalletList;
    },
    ...
    getCedraConfig: function() {
        return getCedraConfig;
    },
    getCedraConnectWallets: function() {
        return getCedraConnectWallets;
    },
    ...
    isCedraConnectWallet: function() {
        return isCedraConnectWallet;
    },
    isCedraLiveNetwork: function() {
        return isCedraLiveNetwork;
    },
    isCedraNetwork: function() {
        return isCedraNetwork;
    },
...
function getSDKWallets(dappConfig) {
    ...
    if (typeof window !== "undefined") {
        sdkWallets.push(new import_wallet_adapter_plugin.CedraConnectGoogleWallet(_object_spread({
        ...
        }, dappConfig === null || dappConfig === void 0 ? void 0 : dappConfig.cedraConnect)), new import_wallet_adapter_plugin.CedraConnectAppleWallet(_object_spread({
            network: dappConfig === null || dappConfig === void 0 ? void 0 : dappConfig.network,
            dappId: dappConfig === null || dappConfig === void 0 ? void 0 : dappConfig.cedraConnectDappId
        }, dappConfig === null || dappConfig === void 0 ? void 0 : dappConfig.cedraConnect)));
    }
    if ((dappConfig === null || dappConfig === void 0 ? void 0 : dappConfig.network) === import_ts_sdk2.Network.MAINNET) {} else {}
    return sdkWallets;
}
// src/WalletCore.ts
    ...
    _create_class(WalletCore, [
        {
            ...
            value: function fetchExtensionAIP62CedraWallets() {
                var _ref = (0, import_wallet_standard.getCedraWallets)(), cedraWallets = _ref.cedraWallets, on = _ref.on;
                this.setExtensionAIP62Wallets(cedraWallets);
                if (typeof window === "undefined") return;
                var that = this;
                var removeRegisterListener = on("register", function() {
                    var _ref = (0, import_wallet_standard.getCedraWallets)(), cedraWallets2 = _ref.cedraWallets;
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                cedra = new import_ts_sdk3.Cedra(cedraConfig);
                                _state.label = 1;
                            case 1:
                                _state.trys.push([
                                    1,
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                ...
                                cedra2 = new import_ts_sdk3.Cedra(cedraConfig2);
                                return [
                                    4,
