// src/encrDecr.ts
import { Ed25519Signature } from "@cedra-labs/ts-sdk";
...
import { Ed25519PublicKey as CedraEd25519PublicKey, Ed25519Signature as Ed25519Signature2, Hex } from "@cedra-labs/ts-sdk";
...
function verifyEnvelopeSignature(publicMessageBytes, privateMessageBytes, messageSignatureInput, senderEd25519PublicKey) {
  ...
  const senderPublicKey = new CedraEd25519PublicKey(senderEd25519PublicKey.key);
  const messageHashBytes = combineHashedEnvelopeMessageBytes(publicMessageBytes, privateMessageBytes);
...
import {
  Deserializer,
  Ed25519PublicKey as CedraEd25519PublicKey2,
...
function deserializeEd25519PublicKeyB64(ed25519PublicKeyB64) {
  return new CedraEd25519PublicKey2(decodeBase64(ed25519PublicKeyB64));
}
...
import { PublicKey as CedraPublicKey } from "@cedra-labs/ts-sdk";
...
function deriveAccountTransportEd25519Keypair(ed25519SecretKeyOrSignCallback, publicKey) {
  const publicKeyBytes = publicKey instanceof CedraPublicKey ? publicKey.toUint8Array() : publicKey.key;
