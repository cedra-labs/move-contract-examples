...
type GetProcessorStatusQuery = {
    processor_metadata_processor_status: Array<{
 ...
 * @category Types
 */
type GetAccountCoinsDataResponse = GetAccountCoinsDataQuery["current_fungible_asset_balances_new"];
/**
 ...
 * @category Types
 */
type GetProcessorStatusResponse = GetProcessorStatusQuery["processor_metadata_processor_status"];
/**
 ...
 * @category Types
 */
type GetCurrentFungibleAssetBalancesResponse = GetCurrentFungibleAssetBalancesQuery["current_fungible_asset_balances_new"];
/**
 ...
 * @category Types
 */
type GetANSNameResponse = GetNamesQuery["current_cedra_names"];
/**
 ...
 */
interface CedraResponse<Req, Res> {
    status: number;
    statusText: string;
    data: Res;
    url: string;
