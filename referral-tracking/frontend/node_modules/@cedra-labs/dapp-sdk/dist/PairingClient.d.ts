import { AccountInfo } from "@cedra-labs/connect-wallet-api";
import { FinalizedPairingData, NetworkName, SerializedDate, SigningRequestStatus, SigningRequestTypes } from "@cedra-labs/api";
import { Ed25519KeyPair, Ed25519PublicKey, Ed25519SecretKey } from "@cedra-labs/crypto";
import { type SignAndSubmitTransactionRequestArgs, type SignAndSubmitTransactionResponseArgs, SignMessageRequestArgs, type SignTransactionRequestArgs, type SignTransactionResponseArgs, type SignTransactionWithPayloadRequestArgs, type SignTransactionWithPayloadResponseArgs, type SignTransactionWithRawTxnRequestArgs, type SignTransactionWithRawTxnResponseArgs } from "@cedra-labs/identity-wallet-api";
...
export declare class ACPairingClient {
    ...
    signMessage(address: string, args: SignMessageRequestArgs, options?: SignRequestOptions): Promise<import("@cedra-labs/identity-wallet-api").FullMessageParams & import("@cedra-labs/identity-wallet-api").FullMessageResult & {
        signature: string;
    }>;
