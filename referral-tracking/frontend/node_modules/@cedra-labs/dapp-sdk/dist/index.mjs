...
} from "@cedra-labs/connect-wallet-api";
import { WebWalletTransport } from "@cedra-labs/web-transport";
import {
  AccountAddress as AccountAddress3,
  AnySignature,
  CedraConfig as CedraConfig2,
  Deserializer,
  Ed25519Signature,
...
import { NetworkName as NetworkName2 } from "@cedra-labs/api";
import { createEd25519KeyPair, encodeBase64 as encodeBase642 } from "@cedra-labs/crypto";
...
function normalizePayloadForIC(payload, cedraConfig) {
  ...
  if (cedraConfig) {
    return payload.abi !== void 0 ? generateTransactionPayloadWithABI({ ...payload, abi: payload.abi }) : generateTransactionPayload({ cedraConfig, ...payload });
  }
...
} from "@cedra-labs/identity-wallet-api";
import axios, {
  AxiosError,
  isAxiosError
} from "axios";
...
var ACDappClient = class {
  ...
  async signAndSubmitTransaction(args) {
    ...
    if (await this.isIcAccount(signerAddress)) {
      ...
      const cedraConfig = new CedraConfig2({ network });
      let convertedArgs;
      if (feePayer !== void 0) {
...
// src/ICDappClient.ts
import { createEd25519KeyPair as createEd25519KeyPair2, encodeBase64 as encodeBase643 } from "@cedra-labs/crypto";
...
import { WebWalletTransport as WebWalletTransport2 } from "@cedra-labs/web-transport";
import { NetworkName as NetworkName3 } from "@cedra-labs/api";
